...
O processo Front-End é implementado em Python utilizando Pygame e Pandas. Ele possui três responsabilidades principais:
...
O Back-End é implementado em C++ utilizando:
...
## Comunicação Entre Threads — Memória Compartilhada

Para reduzir condições de corrida, a memória foi segmentada em buffers especializados com granularidade fina.
